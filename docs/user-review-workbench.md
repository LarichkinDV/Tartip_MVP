...
| medium | acceptance | ACCEPTANCE-EP-024-DATA-CONTRIBUTION-AND-ANONYMIZATION-LAYER | EP-024-DATA-CONTRIBUTION-AND-ANONYMIZATION-LAYER | Data contribution and anonymization layer | docs/acceptance/EP-024-DATA-CONTRIBUTION-AND-ANONYMIZATION-LAYER.acceptance.md | Проверить acceptance report, выполнить команды и заполнить решение пользователя. |
...
|---|---|---|---|---|---|
| EP-024-DATA-CONTRIBUTION-AND-ANONYMIZATION-LAYER | Data contribution and anonymization layer | - | - | - | docs/acceptance/EP-024-DATA-CONTRIBUTION-AND-ANONYMIZATION-LAYER.acceptance.md |
...
| AUD-GIT-002 | medium | 8 | 0 | 8 | False | Historical findings are preserved but hidden from active_review_items while current_detected=false. |
...
| AUD-GIT-006 | medium | 15 | 0 | 15 | False | Historical findings are preserved but hidden from active_review_items while current_detected=false. |
