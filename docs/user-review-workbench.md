...
| Активные блокеры | 4 |
| Historical audit findings | 354 |
| Audit finding groups | 6 |
| Принятые пакеты скрыты из активной очереди | 16 |
...
| AUD-GIT-002 | medium | 1 | 0 | 1 | False | Historical findings are preserved but hidden from active_review_items while current_detected=false. |
...
| AUD-GIT-006 | medium | 8 | 0 | 8 | False | Historical findings are preserved but hidden from active_review_items while current_detected=false. |
